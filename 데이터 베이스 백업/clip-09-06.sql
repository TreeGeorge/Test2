...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='코인 구매 내역 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `buy_coin_list` VALUES (5,'2020-07-23 00:00:00',4000,4),(6,'2020-07-23 00:00:00',50000,1),(7,'2020-06-27 00:00:00',2000,1),(58,'2020-09-05 15:34:14',100400,4),(60,'2020-09-05 17:17:40',50000,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='영화 구매 내역 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `buy_movie_list` VALUES (1,'2020-09-15 00:00:00','N','N',0,3,2),(2,'2020-09-15 00:00:00','N','Y',0,4,4),(4,'2020-08-14 00:00:00','Y','N',3000,4,2),(5,'2020-08-16 00:00:00','N','N',3000,2,3),(6,'2020-09-03 00:00:00','N','N',3000,2,1),(9,'2020-08-14 00:00:00','D','N',0,1,11),(10,'2020-08-14 00:00:00','Y','N',3000,1,13),(11,'2020-09-03 00:00:00','N','Y',3000,1,6),(13,'2020-08-14 00:00:00','D','N',3000,4,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='영화 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `movie` VALUES (1,'다만 악에서 구하소서','B','홍원찬',2000,0,'썸네일 주소','예고편 주소','줄거리 ~~','108분','2008-09-25','15',NULL),(2,'오케이 마담','R','이철하',3000,0,'썸네일 주소','예고편 주소','줄거리 ~~','100분','2010-09-25','15',NULL),(3,'극장판 짱구는 못말려 : 신혼여행 허리케인~ 사라진 아빠!','B','하시모토 마사카즈',4000,0,'썸네일 주소','예고편 주소','줄거리 ~~','100분','2015-09-25',NULL,NULL),(4,'강철비2 : 정상회담','B','양우석',5000,100,'썸네일 주소','예고편 주소','줄거리 ~~','131분','2013-09-25','15','2020-09-20'),(5,'반도','R','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-25','15',NULL),(6,'반도2','B','연상호',6000,23,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-22',NULL,NULL),(7,'반도3','R','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21','19',NULL),(8,'반도3','B','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(9,'반도3','B','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(10,'반도3','B','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21','12',NULL),(11,'반도3','R','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(12,'반도3','B','연상호',6000,11,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(13,'반도3','R','연상호',6000,100,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,'2020-09-20'),(14,'반도3','B','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(15,'반도3','R','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(16,'반도3','B','연상호',6000,100,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,'2020-09-20');
...
INSERT INTO `user` VALUES (1,'master001','master001','조지환','M','1994-07-20','2020-06-02','master001@naver.com','Y',46420,'4567456745674567'),(2,'master002','master001','이세빈','M','1994-07-20','2020-06-02','master002@naver.com','Y',0,'3456345634563456'),(3,'master003','master001','김태희','M','1994-07-20','2020-06-02','master003@naver.com','Y',0,'2345234523452345'),(4,'master004','master001','김채현','M','1994-07-20','2020-06-02','master004@naver.com','Y',125960,'1234123412341234'),(5,'master005','master001','이재건','M','1994-07-20','2020-06-02','master005@naver.com','N',0,NULL),(6,'JWW','0000','주영아','F','1997-10-18','2020-09-01','qq2222@gmail.com','N',0,NULL),(7,'godgoun','master001','조지환','M','1994-07-20','2020-09-03','godgoun@naver.com','Y',0,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='쿠폰과 회원을 연결해주는 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_coupon` VALUES (1,'Y',1,1),(2,'N',1,2),(3,'N',2,2),(4,'N',3,1),(5,'Y',4,1),(6,'N',4,2),(7,'N',5,1),(8,'N',2,1),(10,'N',4,3),(11,'N',1,3);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='장바구니';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wish_list` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,4),(5,3,1),(6,3,5),(7,1,5);
...
-- Dump completed on 2020-09-06 19:56:43
