...
CREATE TABLE `movie` (
  ...
  `is_buy` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Y' COMMENT '영화의 구매 타입 ( 구매 )',
  `is_rent` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Y' COMMENT '영화의 구매 타입 ( 대여 )',
...
INSERT INTO `movie` VALUES (1,'다만 악에서 구하소서','Y','N','홍원찬',2000,0,'썸네일 주소','예고편 주소','줄거리 ~~','108분','2008-09-25','15',NULL),(2,'오케이 마담','Y','Y','이철하',3000,0,'썸네일 주소','예고편 주소','줄거리 ~~','100분','2010-09-25','15',NULL),(3,'극장판 짱구는 못말려 : 신혼여행 허리케인~ 사라진 아빠!','N','Y','하시모토 마사카즈',4000,0,'썸네일 주소','예고편 주소','줄거리 ~~','100분','2015-09-25',NULL,NULL),(4,'강철비2 : 정상회담','Y','Y','양우석',5000,100,'썸네일 주소','예고편 주소','줄거리 ~~','131분','2013-09-25','15','2020-09-20'),(5,'반도','Y','N','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-25','15',NULL),(6,'반도2','Y','Y','연상호',6000,23,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-22',NULL,NULL),(7,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21','19',NULL),(8,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(9,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(10,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21','12',NULL),(11,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(12,'반도3','Y','Y','연상호',6000,11,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(13,'반도3','Y','Y','연상호',6000,100,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,'2020-09-20'),(14,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(15,'반도3','Y','Y','연상호',6000,0,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,NULL),(16,'반도3','Y','Y','연상호',6000,100,'썸네일 주소','예고편 주소','줄거리 ~~','116분','2009-09-21',NULL,'2020-09-20');
...
-- Dump completed on 2020-08-31 18:53:08
